...
export const clineMicrowaveAlphaModelInfo: ModelInfo = {
  ...
  description:
    "Cline Microwave Alpha - Advanced model for complex coding tasks with large context window",
};
// Vertex AI
...
export const moonshotDefaultModelId =
  "kimi-k2-0711-preview" satisfies MoonshotModelId;
...
export const basetenModels = {
  ...
  "deepseek-ai/DeepSeek-V3-0324": {
    ...
    cacheReadsPrice: 0,
    description:
      "DeepSeek V3 0324 - A state-of-the-art 671B-parameter MoE LLM licensed for commercial use.",
  },
  "meta-llama/Llama-4-Maverick-17B-128E-Instruct": {
    maxTokens: 8192,
    contextWindow: 131072,
    ...
    cacheReadsPrice: 0,
    description:
      "Meta's Llama 4 Maverick - A SOTA mixture-of-experts multi-modal LLM with 400 billion total parameters.",
  },
  "meta-llama/Llama-4-Scout-17B-16E-Instruct": {
    maxTokens: 8192,
    contextWindow: 131072,
    ...
    cacheReadsPrice: 0,
    description:
      "Meta's Llama 4 Scout - A SOTA mixture-of-experts multi-modal LLM with 109 billion total parameters.",
  },
  "moonshotai/Kimi-K2-Instruct": {
    maxTokens: 131072,
    contextWindow: 131072,
    ...
    cacheReadsPrice: 0,
    description:
      "Moonshot AI's Kimi K2 - The world's first 1 trillion parameter open source model.",
  },
  "Qwen/Qwen3-235B-A22B-Instruct-2507": {
    maxTokens: 163800,
...
export const basetenDefaultModelId =
  "moonshotai/Kimi-K2-Instruct" satisfies BasetenModelId;
